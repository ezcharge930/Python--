...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        # 创建静态文本
        self.staticText = wx.StaticText(self.pl,label=random.choice(self.NameList),pos=(0,50),size=(400,0),style=wx.TE_CENTER)
        # 创建字体
        # 字体大小，字体包，字体风格，加粗
        font = wx.Font(35,wx.FONTFAMILY_SWISS,wx.FONTSTYLE_NORMAL,wx.FONTWEIGHT_BOLD)
        # 静态文本设置成我们创建的字体
        self.staticText.SetFont(font)
        # 创建按钮
        self.btn1 = wx.Button(self.pl,label='开始抽奖',pos=(100,200))
        self.btn2 = wx.Button(self.pl,label='结束抽奖',pos=(300,200))
        # 绑定事件
